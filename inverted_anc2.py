...
class MultiFileWriter:
    ...
    def upload_to_gcp(self):
        ...
        blob = self.bucket.blob(f"postings_gcp_anc/{file_name}")
        blob.upload_from_filename(file_name)
    
    
    def read_bucket(self, f_name):
        blob = self.bucket.blob(f"postings_gcp_anc/{f_name}")
        return blob.open('rb')
...
class InvertedIndex_anc:  
    ...
    def write_a_posting_list(b_w_pl, bucket_name):
        ...
        with closing(MultiFileWriter(".", bucket_id, bucket_name)) as writer:
            ...
            InvertedIndex_anc._upload_posting_locs(bucket_id, posting_locs, bucket_name)
        return bucket_id
    ...
    def _upload_posting_locs(bucket_id, posting_locs, bucket_name):
        ...
        blob_posting_locs = bucket.blob(f"postings_gcp_anc/{bucket_id}_posting_locs.pickle")
